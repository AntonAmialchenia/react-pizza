    ...
    <div className="container">
      <div className="pizza">
        ...
        <p className="pizza__description">
          ...
          delectus, temporibus atque exercitationem repellat tempora voluptatum
          suscipit beatae in! Neque voluptatibus libero beatae consequuntur ut
          soluta ipsa mollitia fuga?
        </p>
