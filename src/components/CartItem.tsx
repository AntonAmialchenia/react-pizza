...
const CartItem: FC<cartItem> = ({ id, title, imageUrl, type, count, price, size }) => {
  const dispatch = useAppDispatch();

  const onClickPlus = () => {
    dispatch(addItem({ id, title, imageUrl, type, count, price, size }));
  };
  ...
  return (
    <div className="cart__item">
      ...
      <div className="cart__right">
        <div className="cart__right-count">
          <button
            disabled={count === 1}
        ...
        <div className="cart__right-remove">
